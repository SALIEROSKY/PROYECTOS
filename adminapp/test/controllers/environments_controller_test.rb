...
class EnvironmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create environment" do
    assert_difference('Environment.count') do
      post environments_url, params: { environment: { desc_: @environment.desc_, environment: @environment.environment, id_multimedia: @environment.id_multimedia, id_user: @environment.id_user, nam_: @environment.nam_ } }
    end
  ...
  test "should update environment" do
    patch environment_url(@environment), params: { environment: { desc_: @environment.desc_, environment: @environment.environment, id_multimedia: @environment.id_multimedia, id_user: @environment.id_user, nam_: @environment.nam_ } }
