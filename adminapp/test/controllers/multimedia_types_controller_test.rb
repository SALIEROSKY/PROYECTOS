...
class MultimediaTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create multimedia_type" do
    assert_difference('MultimediaType.count') do
      post multimedia_types_url, params: { multimedia_type: { desc_multimedia_type: @multimedia_type.desc_multimedia_type, nam_multimedia_type: @multimedia_type.nam_multimedia_type } }
    end
  ...
  test "should update multimedia_type" do
    patch multimedia_type_url(@multimedia_type), params: { multimedia_type: { desc_multimedia_type: @multimedia_type.desc_multimedia_type, nam_multimedia_type: @multimedia_type.nam_multimedia_type } }
