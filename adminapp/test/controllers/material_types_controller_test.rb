...
class MaterialTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create material_type" do
    assert_difference('MaterialType.count') do
      post material_types_url, params: { material_type: { desc_material_type: @material_type.desc_material_type, nam_material_type: @material_type.nam_material_type } }
    end
  ...
  test "should update material_type" do
    patch material_type_url(@material_type), params: { material_type: { desc_material_type: @material_type.desc_material_type, nam_material_type: @material_type.nam_material_type } }
