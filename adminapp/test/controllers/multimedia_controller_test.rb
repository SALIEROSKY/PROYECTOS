...
class MultimediaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create multimedium" do
    assert_difference('Multimedium.count') do
      post multimedia_url, params: { multimedium: { desc_multimedia: @multimedium.desc_multimedia, id_multimedia_type: @multimedium.id_multimedia_type, multimedia_type_id: @multimedium.multimedia_type_id, nam_multimedia: @multimedium.nam_multimedia } }
    end
  ...
  test "should update multimedium" do
    patch multimedium_url(@multimedium), params: { multimedium: { desc_multimedia: @multimedium.desc_multimedia, id_multimedia_type: @multimedium.id_multimedia_type, multimedia_type_id: @multimedium.multimedia_type_id, nam_multimedia: @multimedium.nam_multimedia } }
